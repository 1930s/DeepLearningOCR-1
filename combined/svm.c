...
char* callPythonFuncSVM(char* filename, char* function, tuple_t args) {
  Py_Initialize();
...
const char *ocrValueSVM(tuple_t tuple) {
  char* retval = (char*) callPythonFuncSVM("svm", "ocrValueSVM", tuple);
  return retval;
} // ocrValueSVM
